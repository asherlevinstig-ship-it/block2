  ...
  function createNpcQuestChains({B,I}={}){
    ...
    return freezeChains({
      'Mara Vale':[
        ...
        {title:'Road Ready', type:'kill', need:3, desc:'Defeat {N} monsters beyond town, then return for a Stone Sword, food, and Level 3. Compare and equip your reward before the first Gate.', gold:24, xp:47, levelTarget:3, rewardItems:[{id:I.STONE_SWORD,count:1},{id:I.COOKED_MEAT,count:2}], objectiveText:'Craft your starter sword, defeat 3 hostile monsters, then earn a Stone Sword upgrade.', objectiveLocation:'Wilderness outside the north gate'},
        ...
        {title:'A Better Sense', type:'utility', utility:'compass', need:1, desc:'Visit the Guild Hall notice board, complete a Guild Contract that awards Compass Sense, equip it, then return to Mara.', gold:42, xp:58, objectiveText:'Visit the Guild Hall notice board and earn Compass Sense from a Guild Contract.', objectiveLocation:'Guild Hall notice board', objectiveAction:{type:'guild_contracts',label:'OPEN GUILD BOARD'}},
        ...
        {title:'A Shadow Companion', type:'familiar', familiar:'shade', need:1, desc:'Recommended level 5+. Use the Shadow Sigil Mara gave you to bind Shade, then return. Press K to call it afterward.', gold:52, xp:72, recommendedLevel:5, rewardItems:[{id:B.EGG_INSULATOR,count:1}]},
        {title:'First Bonded Mount', type:'mount', mount:'dragon', need:1, desc:'Reach Emberwatch Shrine beyond the north gate. Defeat its 3 guardians and press G at the egg podium. Recover the egg, then hatch it on your Egg Insulator.', gold:78, xp:100, recommendedLevel:6, objectiveLocation:'Emberwatch Shrine', objectiveAction:{type:'follow_marker',label:'FIND DRAGON EGG'}},
