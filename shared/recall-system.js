(function(root,factory){
  ...
  'use strict';
  // Unanswered prompts are brief world events. Their question HUD and answer
  // pillars disappear together instead of lingering around the player.
  const COOLDOWN_MS=0,QUESTION_MS=30*1000,FREEZE_MS=0,RESTORE_FRACTION=.2;
  ...
  const QUESTIONS=Object.freeze([
    ...
    Object.freeze({id:'it_ns_bin_den_001',subject:'Computer Science',stage:'KS3',topic:'Number systems',difficulty:1,spec:'number-systems-base2-base10-base16',prompt:'What is binary 1010 in denary?',answers:['10','8','12','1010'],correct:0,explanation:'Binary 1010 uses place values 8, 4, 2 and 1. The 1s are worth 8 and 2, so the total is 10.'}),
    Object.freeze({id:'it_ns_bin_den_002',subject:'Computer Science',stage:'KS3',topic:'Number systems',difficulty:1,spec:'number-systems-base2-base10-base16',prompt:'What is binary 1111 in denary?',answers:['15','14','16','1111'],correct:0,explanation:'Binary 1111 means 8 + 4 + 2 + 1, which equals 15 in denary.'}),
    Object.freeze({id:'it_ns_bin_den_003',subject:'Computer Science',stage:'KS3',topic:'Number systems',difficulty:2,spec:'number-systems-base2-base10-base16',prompt:'What is binary 100101 in denary?',answers:['37','35','41','100101'],correct:0,explanation:'The place values are 32, 16, 8, 4, 2 and 1. Binary 100101 has 32 + 4 + 1, giving 37.'}),
    Object.freeze({id:'it_ns_bin_den_004',subject:'Computer Science',stage:'GCSE',topic:'Number systems',difficulty:2,spec:'number-systems-base2-base10-base16',prompt:'What is binary 11001010 in denary?',answers:['202','210','186','11001010'],correct:0,explanation:'Using 128, 64, 32, 16, 8, 4, 2, 1 gives 128 + 64 + 8 + 2 = 202.'}),
    Object.freeze({id:'it_ns_den_bin_001',subject:'Computer Science',stage:'KS3',topic:'Number systems',difficulty:1,spec:'number-systems-base2-base10-base16',prompt:'What is denary 6 in binary?',answers:['110','101','111','100'],correct:0,explanation:'Denary 6 is made from 4 + 2, so the binary place values 4, 2, 1 become 110.'}),
    Object.freeze({id:'it_ns_den_bin_002',subject:'Computer Science',stage:'KS3',topic:'Number systems',difficulty:1,spec:'number-systems-base2-base10-base16',prompt:'What is denary 13 in binary?',answers:['1101','1011','1110','1001'],correct:0,explanation:'Denary 13 is 8 + 4 + 1, so the 8, 4, 2, 1 columns are 1101.'}),
    Object.freeze({id:'it_ns_den_bin_003',subject:'Computer Science',stage:'KS3',topic:'Number systems',difficulty:2,spec:'number-systems-base2-base10-base16',prompt:'What is denary 42 in binary?',answers:['101010','100110','110010','101100'],correct:0,explanation:'Denary 42 is 32 + 8 + 2, so the 32, 16, 8, 4, 2, 1 columns are 101010.'}),
    Object.freeze({id:'it_ns_den_bin_004',subject:'Computer Science',stage:'GCSE',topic:'Number systems',difficulty:2,spec:'number-systems-base2-base10-base16',prompt:'What is denary 173 as an 8-bit binary number?',answers:['10101101','10110101','11001101','10101011'],correct:0,explanation:'173 is 128 + 32 + 8 + 4 + 1, so the 8-bit pattern is 10101101.'}),
    Object.freeze({id:'it_ns_bin_hex_001',subject:'Computer Science',stage:'KS3',topic:'Number systems',difficulty:1,spec:'number-systems-base2-base10-base16',prompt:'What is binary 1010 in hexadecimal?',answers:['A','10','B','8'],correct:0,explanation:'One hexadecimal digit represents four binary bits. The nibble 1010 has denary value 10, written as A in hex.'}),
    Object.freeze({id:'it_ns_bin_hex_002',subject:'Computer Science',stage:'KS3',topic:'Number systems',difficulty:1,spec:'number-systems-base2-base10-base16',prompt:'What is binary 1111 in hexadecimal?',answers:['F','E','15','1F'],correct:0,explanation:'The four-bit value 1111 is denary 15, and hexadecimal uses F for the value 15.'}),
    Object.freeze({id:'it_ns_bin_hex_003',subject:'Computer Science',stage:'GCSE',topic:'Number systems',difficulty:2,spec:'number-systems-base2-base10-base16',prompt:'What is binary 1101 0110 in hexadecimal?',answers:['D6','C6','D5','13'],correct:0,explanation:'Split the binary into nibbles: 1101 is D and 0110 is 6, so the hexadecimal value is D6.'}),
    Object.freeze({id:'it_ns_bin_hex_004',subject:'Computer Science',stage:'GCSE',topic:'Number systems',difficulty:2,spec:'number-systems-base2-base10-base16',prompt:'What is binary 0011 1010 in hexadecimal?',answers:['3A','4A','3B','32'],correct:0,explanation:'Convert each nibble separately: 0011 is 3 and 1010 is A, giving hexadecimal 3A.'}),
    Object.freeze({id:'it_ns_hex_bin_001',subject:'Computer Science',stage:'KS3',topic:'Number systems',difficulty:1,spec:'number-systems-base2-base10-base16',prompt:'What is hexadecimal C in binary?',answers:['1100','1010','1110','1001'],correct:0,explanation:'Hexadecimal C represents denary 12, which is 8 + 4, so the four-bit binary value is 1100.'}),
    Object.freeze({id:'it_ns_hex_bin_002',subject:'Computer Science',stage:'KS3',topic:'Number systems',difficulty:1,spec:'number-systems-base2-base10-base16',prompt:'What is hexadecimal 9 in binary?',answers:['1001','1010','0110','1111'],correct:0,explanation:'Hexadecimal 9 has the same value as denary 9, which is 8 + 1, so the four-bit binary value is 1001.'}),
    Object.freeze({id:'it_ns_hex_bin_003',subject:'Computer Science',stage:'GCSE',topic:'Number systems',difficulty:2,spec:'number-systems-base2-base10-base16',prompt:'What is hexadecimal 2F in binary?',answers:['0010 1111','0011 1110','0010 1011','1111 0010'],correct:0,explanation:'Convert each hex digit to four bits: 2 is 0010 and F is 1111, giving 0010 1111.'}),
    Object.freeze({id:'it_ns_hex_bin_004',subject:'Computer Science',stage:'GCSE',topic:'Number systems',difficulty:2,spec:'number-systems-base2-base10-base16',prompt:'What is hexadecimal A4 in binary?',answers:['1010 0100','1011 0100','1010 0011','0100 1010'],correct:0,explanation:'A is 1010 and 4 is 0100, so hexadecimal A4 becomes binary 1010 0100.'}),
    Object.freeze({id:'it_ns_base_001',subject:'Computer Science',stage:'KS3',topic:'Number systems',difficulty:1,spec:'number-systems-base2-base10-base16',prompt:'What does base 2 mean?',answers:['It uses two digit symbols: 0 and 1','It uses ten digit symbols: 0 to 9','It uses sixteen digit symbols: 0 to F','It stores every number as text'],correct:0,explanation:'Base 2 is binary. Each column is a power of 2, and only the digit symbols 0 and 1 are used.'}),
    Object.freeze({id:'it_ns_base_002',subject:'Computer Science',stage:'KS3',topic:'Number systems',difficulty:1,spec:'number-systems-base2-base10-base16',prompt:'What does base 10 mean?',answers:['It uses ten digit symbols: 0 to 9','It uses two digit symbols: 0 and 1','It uses sixteen digit symbols: 0 to F','It can only represent ten numbers'],correct:0,explanation:'Base 10 is denary. It uses the ten digit symbols 0 through 9 and place values based on powers of 10.'}),
