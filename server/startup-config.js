...
function summarizeStartupEnv(env = process.env) {
  ...
  return {
    ...
    GAME_QUESTION_MYSQL_HOST: env.GAME_QUESTION_MYSQL_HOST || env.LIVEWEAVE_MYSQL_HOST || env.QUESTION_MYSQL_HOST || '',
    GAME_QUESTION_MYSQL_PORT: env.GAME_QUESTION_MYSQL_PORT || env.LIVEWEAVE_MYSQL_PORT || env.QUESTION_MYSQL_PORT || '',
    GAME_QUESTION_MYSQL_DATABASE: (env.GAME_QUESTION_MYSQL_DATABASE || env.LIVEWEAVE_MYSQL_DATABASE || env.QUESTION_MYSQL_DATABASE) ? '<set>' : '',
    GAME_QUESTION_MYSQL_USER: (env.GAME_QUESTION_MYSQL_USER || env.LIVEWEAVE_MYSQL_USER || env.QUESTION_MYSQL_USER) ? '<set>' : '',
    GAME_QUESTION_MYSQL_PASSWORD: (env.GAME_QUESTION_MYSQL_PASSWORD || env.LIVEWEAVE_MYSQL_PASSWORD || env.QUESTION_MYSQL_PASSWORD) ? '<set>' : '',
