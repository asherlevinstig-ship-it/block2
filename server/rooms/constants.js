...
const ANIMAL_BASE_KIND = {
  ...
  wild_cat: 'cat', wild_dog: 'dog', wild_wolf: 'wolf',
};
const BIOME_ANIMAL = {
...
const BIOME_WILD_PET = {
  [W.BIO.PLAINS]: 'wild_dog', [W.BIO.FOREST]: 'wild_cat', [W.BIO.DESERT]: 'wild_cat',
  [W.BIO.MESA]: 'wild_dog', [W.BIO.SNOWY]: 'wild_wolf', [W.BIO.SWAMP]: 'wild_wolf',
};
...
const FOOD_VALUES = {
  ...
  [I.SMALL_FISH]: { hunger: 6, heal: 1 },
  [I.RIVER_FISH]: { hunger: 10, heal: 1 },
  [I.PRIZED_FISH]: { hunger: 14, heal: 2 },
...
// client furnace simulation so multiplayer furnaces do not silently waste a
// whole staged stack of fuel.
const FUEL_SMELTS = Object.freeze({
  [I.COAL]: 8,
  [I.CHARCOAL]: 8,
  [W.B.PLANKS]: 1.5,
  [W.B.LOG]: 1.5,
