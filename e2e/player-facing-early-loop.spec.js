...
async function expectChapterCheckpoint(page, checkpoints, name, expected) {
...
test('player-facing early loop tracker gives a clear next action at each milestone', async ({ page }) => {
  ...
  await test.step('first quest returns the player to Mara once complete', async () => {
    ...
    await expectChapterCheckpoint(page, checkpoints, 'first hands accepted', {
      title: 'First Hands',
    ...
    await expectChapterCheckpoint(page, checkpoints, 'first hands ready to claim', {
      title: 'First Hands',
  ...
  await test.step('first dungeon objective points at the gate, not D-rank prep', async () => {
    ...
    await expectChapterCheckpoint(page, checkpoints, 'road ready objective', {
    ...
    await page.evaluate(() => window.__BLOCKCRAFT_E2E__.send('npcQuest', { action: 'accept', giver: 'Mara Vale', role: 'guide' }));
    await expectChapterCheckpoint(page, checkpoints, 'road ready accepted', {
      focus: 'first_road_ready',
      title: 'Road Ready',
    ...
    await expectChapterCheckpoint(page, checkpoints, 'road ready ready to claim', {
      focus: 'first_road_ready',
      title: 'Road Ready',
      actionLabel: 'TURN IN TO MARA',
      actionType: 'turn_in',
    ...
    await expectChapterCheckpoint(page, checkpoints, 'first gate accepted', {
      focus: 'first_e_gate',
  ...
  await test.step('post-gate base loop exposes craft, claim, base, and contract actions', async () => {
    ...
    await expectChapterCheckpoint(page, checkpoints, 'craft station no materials', {
    ...
    await expectChapterCheckpoint(page, checkpoints, 'craft station ready', {
      focus: 'first_craft_station',
      title: 'First Craft Station',
      actionLabel: 'OPEN RECIPE',
      actionType: 'craft',
    ...
    await expectChapterCheckpoint(page, checkpoints, 'first land claim no gold', {
    ...
    await expectChapterCheckpoint(page, checkpoints, 'first land claim ready', {
      focus: 'first_land_claim',
      title: 'First Land Claim',
      actionLabel: 'CLAIM LAND',
      actionType: 'land',
    ...
    await expectChapterCheckpoint(page, checkpoints, 'expand claim', {
    ...
    await expectChapterCheckpoint(page, checkpoints, 'base setup', {
    ...
    await expectChapterCheckpoint(page, checkpoints, 'first profession contract handoff', {
  ...
  await test.step('reload preserves the active objective and tracker action', async () => {
    ...
    await expectChapterCheckpoint(page, checkpoints, 'reload first profession contract', {
      focus: 'first_profession_contract',
      title: 'First Contract',
      actionLabel: 'OPEN JOB BOARD',
      actionType: 'jobs',
